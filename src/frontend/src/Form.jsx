      ...
      <div className="self-center bg-emerald-200 px-[700px] h-100 py-40">
        <div className="pt-2">
          ...
          <input
            ...
            type="text"
            name="gi"
            className="shadow-sm    border-gray-300   text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
          />
        </div>
        <div className="pt-2">
